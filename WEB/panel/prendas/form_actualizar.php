...
if (!isset($_SESSION['usuario_info']) or empty(print $_SESSION['usuario_info'])) {
  ...
  //Validamos si existe, si no lo mandamos al index
...
<head>
  ...
  <title>SSK8.CLOTHES - ACTUALIZAR</title>
        ...
        <fieldset>
          ...
          <form class="row" action="../acciones.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
              <label>Nombre</label>
              <input value="<?php print $resultado['nombre'] ?>" type="text" class="form-control" name="nombre" placeholder="Nombre de la prenda" required>
            </div>
            <div class="form-group col-md-6">
              <label>Descripcion</label>
              <input value="<?php print $resultado['descripcion'] ?>" type="text" class="form-control" name="descripcion" placeholder="Añade una descripción de la prenda..." required>
            </div>
            ...
            <div class="form-group col-md-4">
              <label>Precio</label>
              <input value="<?php print $resultado['precio'] ?>" type="text" class="form-control" name="precio" placeholder="0.0€" required>
            </div>
            <div class="form-group col-md-12">
              <input type="submit" name="accion" class="btn btn-info" value="Actualizar">
